...
from algorithm.server.medfedalignpro import (
    MedFedAlignProServer,
    get_medfedalignpro_argparser,
)
...
algo2server = {
    ...
    "MedFedAlignPro": MedFedAlignProServer,
}
algo2argparser = {
    ...
    "MedFedAlignPro": get_medfedalignpro_argparser(),
}
